...
cif\_api/nested.cif &  & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
...
cif\_api/ver2.cif &  &  &  &  &  & \\
local/U+D800.cif &  & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
local/byte-order-mark.cif &  &  &  &  &  & \\
local/deep-empty-list.cif &  &  &  &  &  & \\
local/five-quotes.cif &  &  & $\times$ & $\times$ & $\times$ & /\\
local/magic-code-and-comment.cif &  &  & $\times$ &  &  & \\
local/magic-code-only.cif &  &  &  &  &  & \\
local/space-before-table-sep.cif &  & $\times$ & $\times$ & $\times$ & $\times$ & $\times$\\
